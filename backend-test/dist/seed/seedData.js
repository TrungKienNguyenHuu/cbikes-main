...
const seedData = async () => {
    try {
        ...
        for (const product of productsData) {
            ...
            await database_1.default.query(`INSERT INTO products (product_id, name, url, image_url, created_at)
         VALUES ($1, $2, $3, $4, CURRENT_TIMESTAMP)`, [productId, product.name, product.url, product.imageUrl]);
        }
